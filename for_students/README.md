...
- попробовать бустинг алгоритмы типо xgboost, catboost и прочих
- попробовать другие модели использовать вместо леса
-  если лес, то проверить GridSearchCV и RandomizedSearchCV для оптимизации
